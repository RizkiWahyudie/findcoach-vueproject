<template>
        <teleport to='body'>
            <transition name="alert">
                <div v-if="open" class="flex fixed top-5 right-0 p-4 mb-4 bg-red-100 border-t-4 border-red-500" role="alert">
                    ...
                    <button @click="$emit('close')" class="md:ml-6 -my-1.5 bg-red-100 dark:bg-red-200 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex h-8 w-8" aria-label="Close">
